...
Expected: Retrieve order status information through MCP interface (error for non-existent order)
"""
...
C:\Python313\python.exe -m pytest tests/paper/individual/test_individual_get_order_status_fixed.py -v -s
...
C:\Python313\python.exe -m pytest tests/paper/individual/test_individual_get_order_status_fixed.py::TestIndividualGetOrderStatus::test_get_order_status_basic_functionality -v -s

# Full test class:
C:\Python313\python.exe -m pytest tests/paper/individual/test_individual_get_order_status_fixed.py::TestIndividualGetOrderStatus -v -s
